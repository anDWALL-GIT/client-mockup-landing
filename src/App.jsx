...
function SectionLabel({ children }) {
  return <p className="text-[11px] font-bold uppercase tracking-[0.34em] text-[#9b7844]">{children}</p>;
}
...
function EditorialButton({ children, href = "#collection", dark = false }) {
  return (
    <a
      href={href}
      className={`group inline-flex h-[54px] items-center justify-between gap-5 border px-6 text-[11px] font-bold uppercase tracking-[0.22em] transition ${
        dark
...
export default function App() {
  ...
  return (
    <main className="min-h-screen bg-[#efe7d8] text-[#15120f] selection:bg-[#15120f] selection:text-[#efe7d8]">
      ...
      <header className="sticky top-[5px] z-50 border-b border-[#15120f]/15 bg-[#efe7d8]/95 backdrop-blur-xl">
        <div className="mx-auto grid max-w-[1600px] grid-cols-[1fr_auto_1fr] items-center px-5 py-5 lg:px-10">
          <a href="#" className="justify-self-start">
            <p className="font-serif text-2xl uppercase leading-none tracking-[0.36em]">Auralia</p>
            <p className="mt-1 text-[10px] uppercase tracking-[0.5em] text-[#15120f]/50">Santiago · Berlin</p>
          </a>

          <nav className="hidden items-center gap-10 text-[11px] font-bold uppercase tracking-[0.22em] text-[#15120f]/68 lg:flex">
          ...
          <div className="hidden justify-self-end lg:flex">
            ...
            <button className="ml-3 flex h-12 items-center gap-3 border border-[#15120f] bg-[#15120f] px-6 text-[11px] font-bold uppercase tracking-[0.22em] text-[#efe7d8] transition hover:bg-transparent hover:text-[#15120f]">
              <ShoppingBag size={16} />
              Collection
            </button>
          </div>
        ...
        {menuOpen && (
          <div className="border-t border-[#15120f]/15 px-5 py-6 lg:hidden">
            <nav className="grid gap-5 text-[12px] font-bold uppercase tracking-[0.24em] text-[#15120f]/70">
      ...
      <section className="mx-auto max-w-[1600px] px-5 py-8 lg:px-10 lg:py-12">
        <div className="grid min-h-[790px] border border-[#15120f]/18 lg:grid-cols-[1.04fr_0.96fr]">
          <motion.div
            initial={{ opacity: 0, y: 18 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.75 }}
            className="flex flex-col justify-between border-b border-[#15120f]/18 p-6 md:p-10 lg:border-b-0 lg:border-r lg:p-14"
          >
            <div className="grid grid-cols-2 gap-4 border-b border-[#15120f]/15 pb-8 text-[10px] font-bold uppercase tracking-[0.28em] text-[#15120f]/48">
              <p>Men’s jewelry atelier</p>
              <p className="text-right">Limited European release</p>
            </div>

            <div className="py-14 md:py-20 lg:py-24">
              <p className="mb-8 inline-block border border-[#15120f]/25 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.28em] text-[#15120f]/62">
                Small-batch pieces · stocked in Germany
              </p>
              <h1 className="max-w-5xl font-serif text-[4.5rem] font-normal uppercase leading-[0.78] tracking-[-0.085em] md:text-[7.4rem] xl:text-[10.2rem]">
                No es
                <br />
                adorno.
                <br />
              ...
              <div className="mt-10 grid max-w-4xl gap-8 md:grid-cols-[0.38fr_1fr]">
                <p className="border-l border-[#15120f] pl-4 text-[11px] font-bold uppercase leading-5 tracking-[0.24em] text-[#15120f]/56">
                  Latin character
                  <br />
                  European finish
                </p>
                <p className="max-w-2xl text-lg leading-8 text-[#15120f]/66">
            ...
            <div className="grid gap-3 md:grid-cols-[auto_auto_1fr] md:items-center">
              ...
              <p className="text-right text-[10px] font-bold uppercase tracking-[0.24em] text-[#15120f]/42 max-md:text-left">
          ...
          <motion.div
            ...
            className="relative min-h-[660px] bg-[#15120f] p-6 md:p-10"
          >
            <div className="absolute left-6 top-6 z-20 bg-[#efe7d8] px-4 py-3 text-[10px] font-bold uppercase tracking-[0.26em] text-[#15120f] md:left-10 md:top-10">
              Signature piece
            </div>
            <img
              ...
              className="h-full min-h-[610px] w-full object-cover opacity-92 grayscale-[8%]"
            />
            <div className="absolute bottom-6 left-6 right-6 z-20 grid border border-[#efe7d8]/25 bg-[#15120f]/86 text-[#efe7d8] backdrop-blur md:bottom-10 md:left-10 md:right-10 md:grid-cols-[1fr_auto]">
              <div className="p-5 md:p-7">
                <p className="text-[10px] font-bold uppercase tracking-[0.32em] text-[#d7b46a]">Casino Gold</p>
                <h2 className="mt-2 font-serif text-4xl uppercase tracking-[-0.04em] md:text-5xl">Evening presence</h2>
              ...
              <div className="flex items-center border-t border-[#efe7d8]/20 p-5 md:border-l md:border-t-0 md:p-7">
                <p className="font-serif text-5xl">€98</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid border-y border-[#15120f]/18 py-14 lg:grid-cols-[0.4fr_1fr] lg:py-20">
          ...
          <div>
            <motion.p
              ...
              className="max-w-5xl font-serif text-5xl uppercase leading-[0.95] tracking-[-0.055em] md:text-7xl lg:text-8xl"
            >
              Para hombres que no necesitan llamar la atención, pero siempre la tienen.
            </motion.p>
            <div className="mt-10 grid gap-8 md:grid-cols-2">
              <p className="text-lg leading-8 text-[#15120f]/64">
      ...
      <section id="signature" className="mx-auto max-w-[1600px] px-5 py-14 lg:px-10 lg:py-24">
        <div className="grid gap-10 lg:grid-cols-[0.35fr_1fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit">
            ...
            <h2 className="mt-5 max-w-md font-serif text-6xl uppercase leading-[0.86] tracking-[-0.06em] md:text-7xl">
          ...
          <div className="grid gap-px border border-[#15120f]/18 bg-[#15120f]/18 lg:grid-cols-3">
            {signaturePieces.map((piece, index) => (
              ...
              >
                <div className="relative aspect-[3/4] overflow-hidden bg-[#15120f]">
                  ...
                  />
                  <div className="absolute left-0 top-0 bg-[#efe7d8] px-4 py-3 text-[10px] font-bold uppercase tracking-[0.24em] text-[#15120f]">
                    {piece.line}
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex items-start justify-between gap-5">
                    <div>
                      <h3 className="font-serif text-3xl uppercase leading-none tracking-[-0.04em]">{piece.name}</h3>
                      <p className="mt-4 text-sm leading-6 text-[#15120f]/58">{piece.description}</p>
                    </div>
                    <p className="font-serif text-4xl">€{piece.price}</p>
                  </div>
                  <button className="mt-7 flex h-12 w-full items-center justify-between border border-[#15120f] px-4 text-[11px] font-bold uppercase tracking-[0.2em] transition hover:bg-[#15120f] hover:text-[#efe7d8]">
                    Reserve piece
                    <ArrowRight size={15} />
                  </button>
                </div>
      ...
      <section className="bg-[#15120f] text-[#efe7d8]">
        <div className="mx-auto grid max-w-[1600px] border-y border-[#efe7d8]/15 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="min-h-[620px] p-6 md:p-10">
            <img
          ...
          <div className="flex flex-col justify-center border-t border-[#efe7d8]/15 p-7 md:p-12 lg:border-l lg:border-t-0 lg:p-16">
            <p className="text-[11px] font-bold uppercase tracking-[0.34em] text-[#d7b46a]">Origin</p>
            <h2 className="mt-5 max-w-4xl font-serif text-6xl uppercase leading-[0.86] tracking-[-0.06em] md:text-8xl">
              Born from Latin contrast. Finished for Europe.
            </h2>
            <p className="mt-8 max-w-2xl text-lg leading-8 text-[#efe7d8]/62">
      ...
      <section id="materials" className="mx-auto max-w-[1600px] px-5 py-20 lg:px-10 lg:py-28">
        <div className="grid gap-12 lg:grid-cols-[0.4fr_1fr]">
          ...
          <div className="grid gap-px border border-[#15120f]/18 bg-[#15120f]/18 md:grid-cols-2">
            {materials.map((material) => (
              <div key={material.number} className="bg-[#efe7d8] p-7 md:p-9">
                <p className="font-serif text-6xl text-[#9b7844]">{material.number}</p>
                <h3 className="mt-8 font-serif text-4xl uppercase tracking-[-0.04em]">{material.name}</h3>
      ...
      <section className="mx-auto max-w-[1600px] px-5 pb-20 lg:px-10 lg:pb-28">
        <div className="grid border border-[#15120f]/18 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="flex flex-col justify-center p-7 md:p-12 lg:p-16">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-[#15120f]/64">
            ...
            <div className="mt-10 grid gap-px border border-[#15120f]/18 bg-[#15120f]/18 md:grid-cols-2">
              {packagingItems.map((item) => (
                <div key={item} className="bg-[#efe7d8] p-5 text-[11px] font-bold uppercase tracking-[0.22em] text-[#15120f]/62">
                  {item}
                </div>
              ))}
            </div>
          </div>
          <div className="min-h-[620px] bg-[#15120f] p-6 md:p-10">
            <img
        ...
        <div className="mx-auto max-w-[1600px] px-5 py-20 lg:px-10 lg:py-28">
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              ...
              <h2 className="mt-5 max-w-5xl font-serif text-6xl uppercase leading-[0.86] tracking-[-0.06em] md:text-8xl">
                Stock in Germany. Delivery across Europe.
              </h2>
              <p className="mt-7 max-w-2xl text-lg leading-8 text-[#15120f]/62">
          ...
          <div className="mt-14 grid gap-px border border-[#15120f]/18 bg-[#15120f]/18 md:grid-cols-4">
            {["Shipped from Germany", "Tracked delivery", "EU returns", "Secure checkout"].map((item) => (
              <div key={item} className="bg-[#e4dac8] p-6 text-[11px] font-bold uppercase tracking-[0.22em] text-[#15120f]/62">
                {item}
              </div>
            ))}
          </div>
      ...
      <section id="collection" className="mx-auto max-w-[1600px] px-5 py-20 lg:px-10 lg:py-28">
        <div className="grid gap-10 lg:grid-cols-[0.35fr_1fr]">
          <aside className="lg:sticky lg:top-28 lg:h-fit">
            ...
            <div className="mt-9 grid gap-2">
              {categories.map((category) => (
                <button
                  ...
                  className={`flex h-[52px] items-center justify-between border px-5 text-left text-[11px] font-bold uppercase tracking-[0.22em] transition ${
            ...
            <button className="mt-8 flex h-[52px] w-full items-center justify-between border border-[#15120f]/25 px-5 text-[11px] font-bold uppercase tracking-[0.2em] text-[#15120f]/62 hover:border-[#15120f]">
              Sort by collection
              <ChevronDown size={16} />
            </button>
          </aside>

          <div className="grid gap-px border border-[#15120f]/18 bg-[#15120f]/18 md:grid-cols-2 xl:grid-cols-3">
            {filteredProducts.map((product, index) => (
              ...
              >
                ...
                <div className="border-t border-[#15120f]/18 p-5">
                  <div className="flex items-start justify-between gap-5">
                    <div>
                      <h3 className="font-serif text-2xl uppercase leading-none tracking-[-0.04em]">{product.name}</h3>
                      <p className="mt-3 text-sm text-[#15120f]/52">{product.material}</p>
                    </div>
                    <p className="font-serif text-3xl">€{product.price}</p>
                  </div>
                  <button className="mt-6 flex h-12 w-full items-center justify-between border border-[#15120f] px-4 text-[11px] font-bold uppercase tracking-[0.2em] transition hover:bg-[#15120f] hover:text-[#efe7d8]">
                    View piece
                    <ArrowRight size={15} />
                  </button>
                </div>
      ...
      <section className="bg-[#15120f] text-[#efe7d8]">
        <div className="mx-auto max-w-[1600px] px-5 py-20 text-center lg:px-10 lg:py-28">
          <p className="text-[11px] font-bold uppercase tracking-[0.34em] text-[#d7b46a]">Final invitation</p>
          <h2 className="mx-auto mt-6 max-w-5xl font-serif text-6xl uppercase leading-[0.86] tracking-[-0.06em] md:text-8xl">
            Elige la pieza que habla antes que tú.
          </h2>
          <div className="mt-10 flex justify-center">
            <a
              href="#signature"
              className="inline-flex h-[56px] items-center justify-between gap-6 border border-[#efe7d8] px-8 text-[11px] font-bold uppercase tracking-[0.22em] transition hover:bg-[#efe7d8] hover:text-[#15120f]"
            >
      ...
      <footer className="border-t border-[#15120f]/18 px-5 py-8 lg:px-10">
        <div className="mx-auto flex max-w-[1600px] flex-col justify-between gap-5 text-[10px] font-bold uppercase tracking-[0.24em] text-[#15120f]/48 md:flex-row md:items-center">
